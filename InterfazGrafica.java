...
/**
 * Esta clase se encarga de crear y gestionar la interfaz gráfica de usuario
 * para la
 * administración de tareas. Permite a los usuarios registrarse, iniciar sesión
 * y gestionar sus tareas.
 */
public class InterfazGrafica {
    ...
    /**
     * Constructor que inicializa los componentes principales de la ventana de la
     * aplicación,
    ...
    /**
     * Marca la tarea seleccionada como completada y la actualiza en la lista
     * visual.
     */
    ...
    /**
     * Permite modificar una tarea existente, cambiando su nombre, fecha y
     * prioridad.
    ...
    /**
     * Exporta la lista actual de tareas a un archivo de texto
     * "lista_de_tareas.txt".
     */
